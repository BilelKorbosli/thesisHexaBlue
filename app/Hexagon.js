	...
	function Hexagon(args) {
		...
		var _update = function() {
			...
			for (var i = 0; i < this.walls.length; i++) {
				...
				//console.log(this.walls[1]); // by me
			...
			if (closest_distance>this.walls[1].distance) {
				closest_walls = this.walls[1].walls;
				closest_distance = this.walls[1].distance;
			}
			if (closest_distance>this.walls[2].distance) {
				closest_walls = this.walls[2].walls;
				closest_distance = this.walls[2].distance;
			}
			if (closest_distance>this.walls[3].distance) {
				closest_walls = this.walls[3].walls;
				closest_distance = this.walls[3].distance;
			}
